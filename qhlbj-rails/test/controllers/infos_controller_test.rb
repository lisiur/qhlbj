...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { intro: @info.intro, logo: @info.logo, name: @info.name } }, as: :json
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { intro: @info.intro, logo: @info.logo, name: @info.name } }, as: :json
    assert_response 200
  end
